...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // Assuming you have form fields like 'title', 'link', 'date', etc.
    ...
    if (move_uploaded_file($_FILES["image"]["tmp_name"], $targetFile)) {
      // Update data into the "ads" table using prepared statement
      $image_path = $targetFile; // Use the complete path
      // Update the record in the database
      $updateSql = "UPDATE ads SET title = '$ad_title', link = '$ad_link', image = '$image_path', description = '$ad_desc' WHERE idtag = '$idtag'";
...
if (isset($_GET['idtag'])) {
  ...
  $editSql = "SELECT * FROM ads WHERE idtag = '$idToEdit'";
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title fs-1 text-center">Edit Ad : <?php  echo $id   ?>  </h4>
                                        
                                        <form class="custom-validation" action="#" enctype="multipart/form-data" method="post" >
                                        <div class="my-3">
                                        <div class="drop-container" id="dropContainer" onclick="triggerFileInput()">
                                            ...
                                            <div id="fileList" class="file-list"> <img src=" <?php  echo $image_path   ?> " alt="">  </div>
                                        </div>
                                            <div class="mb-3">
                                                <label class="form-label">Ad Title</label>
                                                <div>
                                                    <input data-parsley-type="alphanum" type="text" value="<?php  echo $title   ?>"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div>
                                                    <textarea required class="form-control" name="ad_desc" maxlength="320"  rows="5" placeholder="Description"><?php  echo $desc   ?></textarea>
                                                </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div>
                                                    <input data-parsley-type="alphanum" type="link" value="<?php  echo $link   ?>"
